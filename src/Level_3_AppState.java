...
/**
 * This is the appstate for level 3. It is attached when the player wants to play it
 * and detached when the player is done. This is also the reason the levels transition
 * between each other once one is done.
 *
 */
public class Level_3_AppState extends BaseAppState{
	private World world;
	...
	protected void cleanup(Application arg0) {
		...
		world.getLevelList().set(2, new Level3(world,world.getAssetManager()));
	}
